...
cognee.config.set_summarization_model("gemini/gemini-2.5-flash")
cognee.config.set_classification_model("gemini/gemini-2.5-flash")
cognee.config.set_graph_model("gemini/gemini-2.5-flash")
